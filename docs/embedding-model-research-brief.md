...
Related reranker family worth understanding alongside the embedding models:

- `Qwen/Qwen3-Reranker-0.6B`
- `Qwen/Qwen3-Reranker-4B`
- `Qwen/Qwen3-Reranker-8B`

Those reranker models matter because good retrieval systems often use both:

- an embedding model for fast first-pass candidate retrieval
- a reranker model for slower but more accurate second-pass ordering

---

## RTEB: Re-evaluation Rationale
...
### RTEB-confirmed alternatives to consider
...
For local llama.cpp serving specifically, BGE-M3 remains the strongest RTEB-adjacent alternative:
